...
TRIG = 11 #Variable que contiene el GPIO al cual conectamos la señal TRIG del sensor
ECHO = 13 #Variable que contiene el GPIO al cual conectamos la señal ECHO del sensor
