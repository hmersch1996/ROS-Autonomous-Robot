...
GPIO.output(23, 0)
""" Global variabels  """
Set_RPM =150                            # SET RPM value
feedback=0.0                          
previous_time =0.0
previous_error=0.0
Integral=0.0           
D_cycal=10
Kp=0.15                                       # Proportional controller Gain (0 to 100)
Ki=0.35                                       # Integral controller Gain (0 to 100)
Kd=0.01                                       # Derivative controller Gain (0 to 100)
RunRPM=0
Loop_value=0
a=0
avr=0
